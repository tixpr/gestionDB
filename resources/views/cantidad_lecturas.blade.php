...
<button id="obtener">
OBTENCION DE LOS CUATRO CAMPOS PROMEDIO
</button>
<ol id="contenido">
</ol>
	...
	var boton = document.getElementById('obtener');
        ...
        function animacion(){
            ...
            for (var i=0,n=elementos.length;i<n;i++)
            {
                ...
                //elementos[i].setAttribute('whidth',width);
			...
			majax.get(
					'/api/lecturas_vistas_resource',
					{
						valid: function(r){
                            ...
                            temp4=null,
                            temp5=null,
                            //la creacion de dos variables para mostrar las dos columnas faltantes
                           // titulo y area
                            temp6=null,
                            temp7=null;
                            ...
                            for(var i = 0, n = r.data.length; i<n; i++){
                                ...
                                temp2.classList.add('type');
                                temp2.innerHTML = data[i].tipo;

//la columna titulo
                               temp6=document.createElement('h3');
                                temp6.classList.add('titulo');
                                temp6.innerHTML = data[i].titulo;
...
//la columna area
                    ...
                    //para que se ejecute las dos columnas
