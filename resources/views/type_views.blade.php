...
<script>
     ...
     function animacion(){
         ...
         for(var i=0, n=elementos.length;i<n;i++){
             ...
             //elementos[i].getAttribute('width',width);
         }
     }
				...
				majax.get(
					'/api/type_views',
                    {
                        valid:function(r){
                            ...
                            //temp.innerHTML='Area :'+"</br>"+ r.data[i].area + "</br>" + data[i].cantidad;
                            ...
                            temp2.innerHTML ='TIPO : '+"</br>"+ data[i].tipo+"</br>"+"</br>";
                            ...
                            temp4.innerHTML = 'CANTIDAD: '+r.data[i].cantidad+"</br>"+"</br>";
