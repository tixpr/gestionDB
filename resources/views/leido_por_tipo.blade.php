...
<html lang="{{ app()->getLocale() }}">
    <head>
		...
		<link href="css/tarea1.css" rel="stylesheet" type="text/css">
		<center> <div class="n"><p>    <b><font color=DARKBLUE face="georgia" size="6"><marquee width="600" scrollamount="8" bgcolor="#FFFFFF">CONSULTA TAREA NUMERO 1: LEIDO POR TIPO</marquee>    </font></b></p><center>
...
<form id="formulario">
			...
			<button id='btn' type="submit">
				OBTENER CANTIDAD DE LECTURAS POR TIPO DE MATERIAL
			</button>
		</form>
		<ul id="contenido">
		</ul>
