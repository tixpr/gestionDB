...
<script>
    ...
    function animacion(){
        var elementos=document.querySelectorAll('div.cantidades');
            ...
            '/api/areas_views', {
                valid:function (r) {
                    ...
                    for(var i =0,n=data.length;i<n; i++){
                        ...
                        temp3.classList.add('cantidades');
...
-
                        ...
                        temp=document.createElement('li');/**'li' es para completar a'ol',para enumerar*/
