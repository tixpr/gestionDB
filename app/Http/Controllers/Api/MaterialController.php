...
use DB;
use App\Http\Resources\Api\{Material as MaterialResource,UserMaterialsView,UserMaterialsLanguageView,UserMaterials, MaterialViews,AreaViews,MaterialTypeView,AreaTypeMaterialView};
...
class MaterialController extends Controller
{
    ...
    public function topMaterials(){
		...
		return MaterialTypeView::collection($resultados);
        
    }
    public function getAreaTypeMaterialView()
    {
     ...
     ->orderBy('cantidad', 'desc')
      ...
      ->get();
      return AreaTypeMaterialView::collection($resultados);
    }
